            ...
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-white/80">Deep analysis of the target company's needs, challenges, and strategic direction.</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-white/80">LinkedIn insights and decision-maker profiles to personalize your approach.</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-white/80">Actionable recommendations tailored to your services and their specific needs.</p>
                </CardContent>
              </Card>
            </div>
          </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 text-white">
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <p className="text-lg">Your profile or company info (LinkedIn or short description)</p>
                    </div>
                    <div className="flex items-start">
                      <span className="text-3xl mr-4 flex-shrink-0">3️⃣</span>
                      <p className="text-lg">The company website you're meeting with</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <p className="text-lg">Names and roles of the participants</p>
                    </div>
                    <div className="flex items-start">
                      <span className="text-3xl mr-4 flex-shrink-0">5️⃣</span>
                      <p className="text-lg">LinkedIn profiles of the participants</p>
                    </div>
                    <div className="flex items-start">
                      <span className="text-3xl mr-4 flex-shrink-0">6️⃣</span>
                      <p className="text-lg">Meeting context (purpose, agenda, or background if known)</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-slate-600">
                  <div className="flex flex-col md:flex-row gap-6 text-center">
                    <div className="flex items-center justify-center">
                      ...
                      <p className="text-white/90 italic text-lg">You can write in your native language.</p>
                    </div>
                    <div className="flex items-center justify-center">
                      <span className="text-3xl mr-3">💡</span>
                      <p className="text-white/90 italic text-lg">The more context you provide, the more powerful and personal your briefing becomes.</p>
                    </div>
                  </div>
                </div>
              </CardContent>
